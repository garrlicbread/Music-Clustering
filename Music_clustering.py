...
# Creating a sample of random predictions and creating two seperate dataframes for them 
...
# Finding the minimum and maximum value of both clusters
...
print()
print(f"This program took {round((end - start), 2)} seconds to execute.")    
